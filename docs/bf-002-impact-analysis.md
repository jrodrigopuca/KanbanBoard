...
| Empty states (`008`)                | **Implemented** | El tablero arranca vacío, permite eliminar cualquier columna y muestra el empty state con CTA para restaurar el board inicial de ejemplo.                         |
...
- El estado inicial vacío y la eliminación de la última columna se orquestan desde [kanban/src/ui/board/useBoardViewModel.js](../kanban/src/ui/board/useBoardViewModel.js).
